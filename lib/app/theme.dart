...
class AppTheme {
  static const Color cBg = Color(0xFF080B14);
  static const Color cSurface = Color(0xFF101424);
  static const Color cEdge = Color(0xFF1A2138);
  static const Color cAccent = Color(0xFF6366F1);
  static const Color cAccent2 = Color(0xFFA5B4FC);
